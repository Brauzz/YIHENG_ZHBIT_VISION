...
void ImageProduceProcess::ImageProcess()
{
    ...
    cv::createTrackbar("offset_x","control",&para_armor.short_offset_x,200);
    cv::createTrackbar("offset_y","control",&para_armor.short_offset_y,200);
    cv::createTrackbar("offset_x","control",&para_armor.long_offset_x,200);
    cv::createTrackbar("offset_y","control",&para_armor.long_offset_y,200);
...
//            solve_angle.getAngle_ICRA(para_armor.points_2d, 14, angle_x_i, angle_y_i, distance_i);
            ...
            {
                solve_angle_long.Generate3DPoints(0, Point2f());
                solve_angle_long.getAngle(para_armor.points_2d, 14,angle_x,angle_y,distance,theta_y);   // pnp姿态结算
            }
